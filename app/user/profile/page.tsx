        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <Card className="border-neutral-100">
            <CardContent className="relative flex items-center gap-4 p-6">
              <Image
                src={user?.profile_picture || rickProfile}
                alt="Profile"
                width={80}
                height={80}
                ...
                priority
              />
              <Button className="size-7 absolute bottom-5 left-20 bg-primary rounded-full">
            ...
            <CardContent className="p-6 space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col gap-1">
                  <Label className="text-neutral-dark">Full Name</Label>
                ...
                <div className="flex flex-col gap-1">
                  <Label className="text-neutral-dark">Email</Label>
                  <div className="w-full p-2 border rounded-md bg-gray-100 text-gray-700">
                    {user?.email || "Loading..."}
                  </div>
                </div>
          ...
          <Card className="border-neutral-100">
            <CardContent className="p-6">
              ...
              <div className="relative bg-gradient-to-r from-primary-light to-secondary-light text-white p-4 rounded-xl">
                ...
                <p>$29/month</p>
                <span>
                  <FaCrown className="text-3xl absolute right-5 top-5" />
                </span>
              </div>
              <ul className="mt-4 text-sm text-gray-600 space-y-2">
                <li className="flex justify-between">
                  All Chat Access: <span className="font-medium">Unlimited</span>
                </li>
                <li className="flex justify-between">
                  Document Storage: <span className="font-medium">50GB</span>
                </li>
                <li className="flex items-center gap-1 justify-between">
                  Priority Support <CheckCircle size={16} className="text-green-500" />
                </li>
              </ul>
            </CardContent>
          </Card>
